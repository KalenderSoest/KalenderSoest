...
class DfxLocationType extends AbstractType
{
        /**
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        $builder
		    ...
		    ->add('name', TextType::class, ['label' => false, 'required' => false, 'attr' => ['placeholder' => 'Name der Veranstaltungsstätte', 'aria-label'=>'Name der Veranstaltungsstätte']])
            ...
            ->add('zusatz', TextareaType::class, ['label' => 'Beschreibung der Veranstaltungsstätte', 'required' => false])
