...
class DfxKartenOrder
{
     ...
     * @var DateTime
     */
    private DateTime $versand;

    /**
     * @var DateTime
     */
    private DateTime $zahlweise;
    ...
    public function setVersand(?DateTime $versand): static
    {
    ...
    public function getVersand(): ?DateTime
    {
        return $this->versand;
    }

    public function setZahlweise(?DateTime $zahlweise): static
    {
    ...
    public function getZahlweise(): ?DateTime
    {
