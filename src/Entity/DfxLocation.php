...
class DfxLocation
{
     ...
     * @var string
     */
    private ?string $vAnzeigen = null;

    /**
     * @var string
     */
    private ?string $geloescht = null;
    ...
    public function setRaumnr(?string $raumnr): static
    {
        $this->raumnr = $raumnr;
    ...
    public function getRaumnr(): ?string
    {
        return $this->raumnr;
    }
     ...
     * Set vAnzeigen
     *
     * @param string $vAnzeigen
     * @return DfxLocation
     */
    public function setVAnzeigen(string $vAnzeigen): static
    {
        $this->vAnzeigen = $vAnzeigen;
     ...
     * @return string 
     */
    public function getVAnzeigen(): string
    {
        return $this->vAnzeigen;
    }
     ...
     * @return DfxLocation
     */
    public function setGeloescht(string $geloescht): static
    {
    ...
    public function setImgLocPos(?string $imgLocPos): static
    {
        $this->imgLocPos = $imgLocPos;

        return $this;
    }

    public function getImgLocPos(): ?string
    {
        return $this->imgLocPos;
    }
    ...
    public function setImgLoc(?string $imgLoc): static
    {
        $this->imgLoc = $imgLoc;
